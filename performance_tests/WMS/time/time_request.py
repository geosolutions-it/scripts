...
def getLayer(root, layerName):
    return root.find(f".//{{http://www.opengis.net/wms}}Capability/{{http://www.opengis.net/wms}}Layer/{{http://www.opengis.net/wms}}Layer/[{{http://www.opengis.net/wms}}Name='{layerName}']")
...
if __name__ == '__main__':
    ...
    if (verbose):
        print("details: ")
        print(f"   layername: {layer}")
        print(f"   capabilities_doc: {str(capabilities_doc)}")
        print(f"Scanning {capabilities_doc}")
